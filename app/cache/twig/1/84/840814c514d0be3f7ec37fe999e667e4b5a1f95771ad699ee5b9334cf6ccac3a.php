...
class __TwigTemplate_70ae1a3ea5e2d86b52f4ad4b8f14b8dbe73d6e8fe9c5b1f57d44c7414a4a117c extends Twig_Template
{
    ...
    {
        // line 1
        if ((isset($context["pdf_title"]) ? $context["pdf_title"] : null)) {
            // line 2
...
<table align=\"center\" width=\"100%\" class=\"full-width border-thin\">
    ...
    ";
        ...
        ";
            // line 45
            if (((($this->getAttribute((isset($context["pdf_session_info"]) ? $context["pdf_session_info"] : null), "access_start_date", array()) != "") &&  !twig_test_empty($this->getAttribute((isset($context["pdf_session_info"]) ? $context["pdf_session_info"] : null), "access_end_date", array()))) && ($this->getAttribute((isset($context["pdf_session_info"]) ? $context["pdf_session_info"] : null), "access_end_date", array()) != "0000-00-00"))) {
                // line 46
                echo "        <tr>
            <td style=\"background-color: #E5E5E5; text-align: left; width:130px;\">
                <strong>";
...
";
        // line 95
        if ( !twig_test_empty((isset($context["add_signatures"]) ? $context["add_signatures"] : null))) {
            // line 96
            echo "    <br />
    <br />
    ...
    <table class=\"full-width\">
        <tr>
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["add_signatures"]) ? $context["add_signatures"] : null));
...
";
    ...
    {
        return new Twig_Source("", "default/export/table_pdf.tpl", "C:\\wamp64\\www\\chamilo-CVO_VOLT-1.11.6\\main\\template\\default\\export\\table_pdf.tpl");
    }
}
