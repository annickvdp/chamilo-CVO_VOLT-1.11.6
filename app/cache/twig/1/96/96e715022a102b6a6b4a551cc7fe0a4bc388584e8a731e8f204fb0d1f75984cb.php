...
class __TwigTemplate_3d3668d7d499dae200cbbd5157b13ddf168839ea2e38c7ca07097dd91919d8fe extends Twig_Template
{
        ...
        ";
            ...
            if ( !$this->getAttribute($context["row"], "show_simple_session_info", array())) {
                ...
                if (($this->getAttribute($context["row"], "course_list_session_style", array()) == 1)) {
                    ...
                    // line 8
                    echo "                    ";
                    if (((isset($context["remove_session_url"]) ? $context["remove_session_url"] : null) == true)) {
                        // line 9
                    ...
                    if ((twig_length_filter($this->env, $this->getAttribute($context["item"], "coaches", array())) > 0)) {
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["coach"]) {
                            ...
                            echo "
                                                    <a href=\"";
                            // line 77
                            echo (($this->getAttribute((isset($context["_p"]) ? $context["_p"] : null), "web_ajax", array()) . "user_manager.ajax.php?") . twig_urlencode_filter(array("a" => "get_user_popup", "user_id" => $this->getAttribute($context["coach"], "user_id", array()), "session_id" => $this->getAttribute($context["row"], "id", array()), "course_id" => $this->getAttribute($context["item"], "real_id", array()))));
                            echo "\"
                                                       data-title=\"";
                            // line 78
...
";
    ...
    {
        return new Twig_Source("", "default/user_portal/classic_session.tpl", "C:\\wamp64\\www\\chamilo-CVO_VOLT-1.11.6\\main\\template\\default\\user_portal\\classic_session.tpl");
    }
}
