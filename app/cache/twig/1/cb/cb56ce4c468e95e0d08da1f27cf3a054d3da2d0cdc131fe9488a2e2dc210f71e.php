...
class __TwigTemplate_59f129d9a2279f26544bbc2fed5e937577ba0c9a1d9ed91d309a03750ba55be0 extends Twig_Template
{
...
";
    ...
    ";
            // line 18
            if (((isset($context["filtered_category"]) ? $context["filtered_category"] : null) && ((isset($context["filtered_category"]) ? $context["filtered_category"] : null) != $this->getAttribute($this->getAttribute($context["lp_data"], "category", array()), "id", array())))) {
                // line 19
                echo "        ";
    ...
    ";
            ...
            if ((isset($context["show_category"]) ? $context["show_category"] : null)) {
                // line 23
                echo "        ";
                if (((isset($context["configuration"]) ? $context["configuration"] : null) == 0)) {
                    // line 24
                    echo "        <!--- old view -->
        ";
                    // line 25
                    if (((twig_length_filter($this->env, (isset($context["categories"]) ? $context["categories"] : null)) > 1) && $this->getAttribute($this->getAttribute($context["lp_data"], "category", array()), "id", array()))) {
                        // line 26
                        echo "            ";
                    ...
                    ";
                            ...
                            if (($this->getAttribute($this->getAttribute($context["lp_data"], "category", array()), "getId", array(), "method") > 0)) {
                                // line 31
                                echo "                        ";
                                if ( !$this->getAttribute((isset($context["_c"]) ? $context["_c"] : null), "session_id", array())) {
                                    // line 32
                                    echo "                            <a href=\"";
                            ...
                            ";
                                    // line 36
                                    if ($this->getAttribute((isset($context["subscription_settings"]) ? $context["subscription_settings"] : null), "allow_add_users_to_lp_category", array())) {
                                        // line 37
                                        echo "                            <a href=\"";
                        ...
                        ";
                                ...
                                if (($this->getAttribute($context["lp_data"], "category_visibility", array()) == 0)) {
                                    ...
                                    echo (($this->getAttribute((isset($context["_p"]) ? $context["_p"] : null), "web_cid_query", array()) . "&") . twig_urlencode_filter(array("action" => "toggle_category_visibility", "id" => $this->getAttribute($this->getAttribute($context["lp_data"], "category", array()), "id", array()), "new_status" => 1)));
                                    echo "\"
                               title=\"";
                                    // line 65
                                    echo get_lang("Show");
                        ...
                        ";
                                    ...
                                    // line 69
                                    echo "                            <a href=\"lp_controller.php?";
                                    echo (($this->getAttribute((isset($context["_p"]) ? $context["_p"] : null), "web_cid_query", array()) . "&") . twig_urlencode_filter(array("action" => "toggle_category_visibility", "id" => $this->getAttribute($this->getAttribute($context["lp_data"], "category", array()), "id", array()), "new_status" => 0)));
                                    echo "\"
                               title=\"";
                                    // line 70
                                    echo get_lang("Hide");
                        ...
                        ";
                                ...
                                if (($this->getAttribute($context["lp_data"], "category_is_published", array()) == 0)) {
                                    // line 76
                                    echo "                            <a href=\"lp_controller.php?";
                                    echo (($this->getAttribute((isset($context["_p"]) ? $context["_p"] : null), "web_cid_query", array()) . "&") . twig_urlencode_filter(array("action" => "toggle_category_publish", "id" => $this->getAttribute($this->getAttribute($context["lp_data"], "category", array()), "id", array()), "new_status" => 1)));
                                    echo "\"
                               title=\"";
                                    // line 77
                        ...
                        ";
                                    ...
                                    // line 81
                                    echo "                            <a href=\"lp_controller.php?";
                                    echo (($this->getAttribute((isset($context["_p"]) ? $context["_p"] : null), "web_cid_query", array()) . "&") . twig_urlencode_filter(array("action" => "toggle_category_publish", "id" => $this->getAttribute($this->getAttribute($context["lp_data"], "category", array()), "id", array()), "new_status" => 0)));
                                    echo "\"
                               title=\"";
                                    // line 82
...
";
    ...
    {
        return new Twig_Source("", "default/learnpath/list.tpl", "C:\\wamp64\\www\\chamilo-CVO_VOLT-1.11.6\\main\\template\\default\\learnpath\\list.tpl");
    }
}
